...
class TrackLogPuller(object):
    ...
    if hostname == 'duo':
        ...
        LOCAL_LOG_STORE_ROOT = "/home/paepcke/Project/VPOL/Data/EdXTrackingOsect22_2013/"
    elif hostname == 'datastage':
        LOCAL_LOG_STORE_ROOT = "/home/dataman/Data/EdX"
    else:
        LOCAL_LOG_STORE_ROOT = ''
...
#    sys.exit(0)
    ...
    #sys.exit()
    #
    #print(tblCreator.identifyNewLogFiles("/home/quentin/EdxLogs/debug"))
